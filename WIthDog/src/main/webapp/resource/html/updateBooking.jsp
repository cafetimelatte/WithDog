    ...
    <div id="Container">
        <div class="sContainer">
            ...
            <div class="s21_tour_de_top">
                <h3 class="area" style="height:60px">숙소 예약 수정 [예약번호 : RWSKWDIFDK]
                </h3>
                        ...
                        <ul class="s21_detail_twrap_mod">
                            ...
                            <li>
                                <dl>
                                    <dt>입실날짜</dt>
                                    <dd>
                                    	<input style="width:200px" type="date" value="2021-09-03">
                                    </dd>
                                    <dt>퇴실날짜</dt>
                                    <dd>
                                    	<input style="width:200px" type="date" value="2021-09-05">
									</dd>
                                </dl>
                            </li>
                            <li>
                                <dl>
                                    ...
                                    <dt>동반애완동물</dt>
                                    <dd>
                                    	<select style="text-align:center;height:24px;width:10%" value="2">
                                    		<option>0</option>
                                    		<option>1</option>
                                    		<option>2</option>
                                    	</select>마리
                            	...
                            	<input class="bbtn" type="button" value="수정하기" name="submit">
